	   ...
	   case SECT_HILLS:
	     ...
	     break;
           ...
           case SECT_WATER_SWIM:	
             set char_color( AT_RMDESC_WATER_SWIM_DAY, ch );
             break;
           case SECT_WATER_NOSWIM:
             set char_color( AT_RMDESC_WATER_NOSWIM_DAY, ch );
             break;
           case SECT_UNDERWATER:
             set char_color( AT_RMDESC_UNDERWATER_DAY, ch );
             break;
           case SECT_AIR:
	   ...
	   case SECT_MOUNTAIN:
	     ...
	     break;
           case SECT_WATER_SWIM:
             ...
             break
           case SECT_WATER_NOSWIM:
             set_char_color( AT_RMDESC_NOSWIM_NITE, ch );
             break;
           case SECT_UNDERWATER:
