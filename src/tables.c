...
SPELL_FUN *spell_function( char *name )
{
    ...
    if ( !str_cmp( name, "spell_crush" ))	     return spell_crush;
    ...
    if ( !str_cmp( name, "spell_meteor_swarm" ))     return spell_meteor_swarm;
    ...
    if ( !str_cmp( name, "spell_turn" ))	     return spell_turn;
    ...
    if ( !str_cmp( name, "spell_shadowfire" ))	     return spell_shadowfire;
    ...
    if ( !str_cmp( name, "spell_retribution" ))	     return spell_retribution;
    ...
    if ( !str_cmp( name, "spell_web" ))		     return spell_web;
...
DO_FUN *skill_function( char *name )
{
	...
	if ( !str_cmp( name, "do_bug" ))		return do_bug;
        if ( !str_cmp( name, "do_buglist" ))		return do_buglist;
	...
	break;
    case 'd':
	if ( !str_cmp( name, "do_dblbackstab" ))	return do_dblbackstab;
	...
	if ( !str_cmp( name, "do_elemental_fury" ))	return do_elemental_fury;
	...
	if ( !str_cmp( name, "do_hold" ))		return do_hold;
	...
	if ( !str_cmp( name, "do_idea" ))		return do_idea;
        if ( !str_cmp( name, "do_idealist" ))		return do_idealist;
	...
	if ( !str_cmp( name, "do_interface" ))		return do_interface;
...
/*	if ( !str_cmp( name, "do_opentourney" ))	return do_opentourney; */
	...
	break;
    case 'q':
        if ( !str_cmp( name, "do_qflag" ))		return do_qflag;
	...
	if ( !str_cmp( name, "do_recent" ))		return do_recent;
	...
	if ( !str_cmp( name, "do_typo" ))		return do_typo;
        if ( !str_cmp( name, "do_typolist" ))		return do_typolist;
	break;
    case 'u':
...
char *spell_name( SPELL_FUN *spell )
{
    ...
    if ( spell == spell_crush )		    return "spell_crush";
    ...
    if ( spell == spell_meteor_swarm )	    return "spell_meteor_swarm";
    ...
    if ( spell == spell_turn )		    return "spell_turn";
    ...
    if ( spell == spell_shadowfire )	    return "spell_shadowfire";
    ...
    if ( spell == spell_retribution )	    return "spell_retribution";
    ...
    if ( spell == spell_web )		    return "spell_web";
...
char *skill_name( DO_FUN *skill )
{
    ...
    if ( skill == do_buglist )		return "do_buglist";
    ...
    if ( skill == do_dblbackstab )	return "do_dblbackstab";
    ...
    if ( skill == do_elemental_fury )   return "do_elemental_fury";
    ...
    if ( skill == do_resetpassword )	return "do_resetpassword";
    ...
    if ( skill == do_hold )		return "do_hold";
    ...
    if ( skill == do_idealist )		return "do_idealist";
    ...
    if ( skill == do_interface )	return "do_interface";
...
/*  if ( skill == do_opentourney )	return "do_opentourney"; */
    ...
    if ( skill == do_qflag ) 		return "do_qflag";
    ...
    if ( skill == do_recent )		return "do_recent";
    ...
    if ( skill == do_typolist )		return "do_typolist";
