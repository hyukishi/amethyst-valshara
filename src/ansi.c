...
/*
 * $Log: ansi.c,v $
 * Revision 1.4  1999/01/12 06:43:36  dotd
 * *** empty log message ***
 *
 * Revision 1.3  1999/01/11 06:51:11  dotd
 * DOTD License Header added prior to release of 2.2.2
 *
 * Revision 1.2  1998/12/16 19:10:03  dotd
 * added rcs id and log keywords
 *
 */

//static char rcsid[] = "$Id: ansi.c,v 1.4 1999/01/12 06:43:36 dotd Exp $";
...
char *color_str( sh_int AType, CHAR_DATA *ch )
{
    ...
    switch( och->pcdata->colorize[AType] )
    {
