...
const   struct  race_type       _race_table      [MAX_RACE]      =
{
    ...
    {
	"Dwarf",     {{1 << AFF_INFRARED,0,0,0}},	1, 0, 1, 0, 2,-1, 0, 6,-6, 0, 0,	(CLASS_MAGE) | (CLASS_PALADIN),								    LANG_DWARVEN
    },

    {
	"Halfling",     {{1<<AFF_SNEAK,0,0,0}},     -2, 1, 0, 0, 1, 0, 0, -3,10, 0, 0,	(CLASS_MAGE) | (CLASS_DRUID) | (CLASS_CLERIC) | ( CLASS_AUGURER) | (CLASS_PALADIN),			    LANG_HALFLING
    },
...
"lizardman", "gnome", "r5", "troll", "r7", "r8", "troll",
...
"augurer", "paladin", "necromancer", "BlackBelt", "caller", "savage", "pirate",
...
char * s_bonk_messages[15] =
{
        "miss", "brush", "lightly tap", "rap", "bonk", "* bonk *",
