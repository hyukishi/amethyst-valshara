...
static void dns_sigterm( int signum )
{
...
int main( int argc, char **argv )
{
  ...
  for (;;)
  {
    ...
    /* Collect any children - and yes, this is the correct way to handle this.
     * Using waitpid left zombies behind too often.
     */
    wait( NULL );
  }
